...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'salary' => ['type' => 'float', 'length' => 10, 'precision' => 0, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'balance' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'extra_lace' => ['type' => 'float', 'length' => 10, 'precision' => 0, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'balance' => 1,
                'extra_lace' => 1,
                'created' => '2019-03-05 22:32:03',
                'modified' => '2019-03-05 22:32:03'
            ],
        ];
        parent::init();
    }
