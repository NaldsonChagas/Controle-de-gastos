...
class PurchasesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_constant_payment' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_constant_payment' => 1,
                'user_id' => 1,
                'created' => '2019-03-06 16:52:37',
                'modified' => '2019-03-06 16:52:37'
            ],
        ];
        parent::init();
    }
